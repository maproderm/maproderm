(function ($, root, undefined) {
	...
	root.ideapark_init_custom_select = function () {
		$('.variations select:not(.hasCustomSelect), select.thwepof-input-field, .widget select, .wpcf7-select').addClass('j-width-100');
		$('select.styled:not(.hasCustomSelect), select.orderby:not(.hasCustomSelect), .variations select:not(.hasCustomSelect), .widget select:not(.hasCustomSelect):not(.woocommerce-widget-layered-nav-dropdown):not(.dropdown_product_cat), select.thwepof-input-field, .wpcf7-select').each(function () {
			$(this).customSelect({
