...
<div class="header">
	...
	<section class="shipping-calculator-form" <?php ideapark_style( 'display:none;' ) ?>>
		...
		<p class="c-cart__calculator-update-wrap update-button">
			<button type="submit" name="calc_shipping" value="1" class="c-button c-button--outline c-cart__calculator-update-button button"><?php esc_html_e( 'Update', 'woocommerce' ); ?></button>
		</p>
