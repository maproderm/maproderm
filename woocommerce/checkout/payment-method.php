...
<li class="wc_payment_method payment_method_<?php echo esc_attr( $gateway->id ); ?>">
	<span class="c-cart__payment-methods-wrap">
		<input id="payment_method_<?php echo esc_attr( $gateway->id ); ?>" type="radio" class="c-cart__payment-method-radio input-radio" name="payment_method" value="<?php echo esc_attr( $gateway->id ); ?>" <?php checked( $gateway->chosen, true ); ?> data-order_button_text="<?php echo esc_attr( $gateway->order_button_text ); ?>" /><i></i>
	</span>
