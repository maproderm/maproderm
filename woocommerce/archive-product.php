...
ideapark_mod_set_temp( '_with_filter', $with_filter );
...
ideapark_mod_set_temp( '_product_layout_class', ( $with_sidebar ? 'c-product-grid__item--sidebar ' : '' ) . 'c-product-grid__item--' . $layout . ( $layout != 'compact' ? ' c-product-grid__item--normal' : '' ) );
?>
...
<div
	...
	<div
		...
		<div
			...
			<?php if ( $subcategories = woocommerce_maybe_show_product_subcategories() ) { ?>
			...
			<?php wc_get_template( 'global/ordering.php' ); ?>
